...
const trackBookingSocialClick = (eventName) => {
    const analytics = window.airdoxAnalyticsV2 || window.airdoxAnalytics;
    analytics?.trackInteraction?.(eventName, 'booking', 'click');
};

const BookingSocialLinks = () => (
    <div className="booking-socials">
        {socialLinks.map((link) => (
            <a
                ...
                onClick={() => trackBookingSocialClick(link.eventName)}
            >
...
export default BookingSocialLinks;
