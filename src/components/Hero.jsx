    ...
    return (
        <section className="hero" id="home" ref={heroRef} data-version="0.1.1">
            ...
            <div className="hero-socials">
                ...
                <a href="https://instagram.com/airdox_bln" target="_blank" rel="noopener noreferrer" className="social-link interactive" onClick={() => { trackHero('social_instagram'); window.airdoxAnalytics?.trackOutboundLink('Instagram', 'https://instagram.com/airdox_bln'); }}>
                    <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="mailto:airdox82@gmail.com" className="social-link interactive" onClick={() => trackHero('social_email')}>
                    <svg viewBox="0 0 24 24" fill="currentColor">
