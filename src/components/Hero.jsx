        ...
        <section className="hero" id="home" ref={heroRef} data-version="0.1.1">
            ...
            <div className={`hero-content ${loaded ? 'loaded' : ''}`}>
                ...
                <div className="hero-socials">
                    <a href="https://soundcloud.com/airdox" target="_blank" rel="noopener noreferrer" className="social-link interactive" onClick={() => trackHero('social_soundcloud')}>
                    ...
                    <a href="https://www.mixcloud.com/Airdox/" target="_blank" rel="noopener noreferrer" className="social-link interactive" onClick={() => trackHero('social_mixcloud')}>
                        <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="https://instagram.com/airdox_bln" target="_blank" rel="noopener noreferrer" className="social-link interactive" onClick={() => trackHero('social_instagram')}>
                        <svg viewBox="0 0 24 24" fill="currentColor">
