...
const trackSocial = (platform, url) => {
    ...
    if (analytics?.trackInteraction) {
        analytics.trackInteraction(`social_${platform.toLowerCase()}`, 'hero', 'click');
    }
    if (window.airdoxAnalytics?.trackOutboundLink) {
        window.airdoxAnalytics.trackOutboundLink(platform, url);
    }
};
    ...
    return (
        <div className="hero-socials">
            <a 
                ...
                onClick={() => trackSocial('SoundCloud', 'https://soundcloud.com/airdox')}
            ...
            <a 
                ...
                rel="noopener noreferrer" 
                className="social-link interactive" 
                onClick={() => trackSocial('Mixcloud', 'https://www.mixcloud.com/Airdox/')}
                aria-label="Mixcloud"
            >
                <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a 
                ...
                rel="noopener noreferrer" 
                className="social-link interactive" 
                onClick={() => trackSocial('Instagram', 'https://instagram.com/airdox_bln')}
            ...
            <a 
                ...
                className="social-link interactive" 
                onClick={() => trackSocial('Email', 'mailto:airdox82@gmail.com')}
                aria-label="Email"
            >
                <svg viewBox="0 0 24 24" fill="currentColor">
