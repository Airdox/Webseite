...
- `docs/agent-system/AGENT_CONTINUOUS_LEARNING.md`: Definition von Lernen im System.
- `docs/agent-system/MENTOR_LEARNING_LOOPS.md`: Ablauf fuer Fehler, Risiko, Quellenpruefung und Folgearbeit.
