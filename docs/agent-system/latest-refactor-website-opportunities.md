...
Generated: 2026-06-01T19:48:04.713Z
Agent: Refactor
...
| high | maintainability | large-file-src-lib-stats-logic-js | 995 lines / 37499 bytes. | Extract only the next user-visible or service-flow subunit that can receive a focused test. | Run the nearest component/unit test plus npm run build. | src/lib/stats-logic.js |
