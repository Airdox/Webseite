...
| Repository | GitHub- und Branch-Organisation, Versionskontrolle, Release-Flow | `docs/agent-system/reports/operations/REPOSITORY_GOVERNANCE.md`, Workflows, Branch-Regeln | Branch-Disziplin, Commit-Qualitaet, Merge-Stabilitaet |

Aufgaben- und Trigger-Zuweisungen liegen in:
- `docs/agent-system/reports/operations/SUPERAGENT_ASSIGNMENTS.md`
