...
- Manni fuehrt dieses Ziel operativ ueber `docs/agent-system/reports/campaigns/MANNI_GROWTH_PLAYBOOK.md`.
- Der aktive Reichweiten-Sprint liegt in `docs/agent-system/REACH_SPRINT_2026-05-02.md`.
- Der verbindliche Meilenstein- und Messplan liegt in `docs/agent-system/reports/campaigns/AIRDOX_REACH_MASTERPLAN_2026-05-08.md`.
