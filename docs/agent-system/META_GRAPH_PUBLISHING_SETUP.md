...
```text
docs/agent-system/social-auto-output/recording-2026-05-24/pfingsten-full-set-now-on-youtube-instagram-facebook-reel-qr.mp4
```
...
```powershell
npm run social:meta:publish -- --platform=instagram --dry-run --video-url="<PUBLIC_MP4_URL>" --caption-file="docs/agent-system/social-auto-output/recording-2026-05-24/pfingsten-full-set-now-on-youtube-instagram-facebook-caption.md"
```

Live nach Freigabe:

```powershell
npm run social:meta:publish -- --platform=instagram --video-url="<PUBLIC_MP4_URL>" --caption-file="docs/agent-system/social-auto-output/recording-2026-05-24/pfingsten-full-set-now-on-youtube-instagram-facebook-caption.md"
```
...
```powershell
npm run social:meta:publish -- --platform=facebook --dry-run --video-url="<PUBLIC_MP4_URL>" --caption-file="docs/agent-system/social-auto-output/recording-2026-05-24/pfingsten-full-set-now-on-youtube-instagram-facebook-caption.md"
```

Live nach Freigabe:

```powershell
npm run social:meta:publish -- --platform=facebook --video-url="<PUBLIC_MP4_URL>" --caption-file="docs/agent-system/social-auto-output/recording-2026-05-24/pfingsten-full-set-now-on-youtube-instagram-facebook-caption.md"
```

Beide Kanaele nach Freigabe:

```powershell
npm run social:meta:publish -- --platform=both --video-url="<PUBLIC_MP4_URL>" --caption-file="docs/agent-system/social-auto-output/recording-2026-05-24/pfingsten-full-set-now-on-youtube-instagram-facebook-caption.md"
```
