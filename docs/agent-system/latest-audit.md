...
| Winnie | 100/100 | Windows Flight Deck, lokale Automatisierung, Datenbankkommunikation und Release-Stabilitaet. |
...
- PASS: Manifest wird nicht im Main-Prozess ausgefuehrt - Warnung, wenn Workspace-Dateien per dynamic import im Main-Prozess ausgefuehrt werden.
- PASS: Shell-Kommandos eingegrenzt - Warnung, wenn Pipeline-Kommandos ueber shell:true laufen.
- PASS: Electron Sandbox aktiv oder begruendet - Warnung, wenn BrowserWindow mit sandbox:false laeuft.
